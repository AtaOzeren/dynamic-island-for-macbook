...
/// Everything runs on the watchdog queue (label `com.kernotch.cpu-watchdog`,
...
public final class ProcessCPUSampler: @unchecked Sendable {
    ...
    private let watchdogQueue = DispatchQueue(label: "com.kernotch.cpu-watchdog", qos: .utility)
