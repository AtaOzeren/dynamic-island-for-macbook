...
/// seam that lives in `KerNotchProviders`, and routing the decision through the
...
public struct OnboardingWindowView: View {
    ...
    private var welcomeStep: some View {
        heading(
            title: localized("Welcome to KerNotch"),
            body: localized(
                """
                KerNotch turns the area around your notch into a live activity \
    ...
    private var permissionsStep: some View {
        VStack(alignment: .leading, spacing: metrics.rowSpacing) {
            heading(
                ...
                body: localized(
                    """
                    KerNotch asks for nothing right now. Each permission is \
                    requested only when you turn on the feature that needs it, and \
                    only after KerNotch explains what it is about to ask for.
                    """)
            )
    ...
    private var doneStep: some View {
        VStack(alignment: .leading, spacing: metrics.rowSpacing) {
            heading(
                ...
                body: localized(
                    """
                    KerNotch lives in the menu bar. Everything you just saw — \
    ...
    private var agentsBodyText: String {
        flow.detectedAgents.isEmpty
            ...
            : localized(
                """
                KerNotch found configuration for the agents below. Turning one \
