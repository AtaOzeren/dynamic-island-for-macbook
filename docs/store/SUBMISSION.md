...
- App Store scheme: `KerNotch (App Store)` using the `AppStore` configuration
- Bundle identifier: `com.kernotch.KerNotch`
- Version/build: `1.0.0` (`1`)
- Sandbox entitlements: `KerNotch-AppStore.entitlements`
...
2. Register `com.kernotch.KerNotch` and create the app record in App Store Connect.
...
4. Open `dist/app-store/KerNotch.xcarchive` in Xcode Organizer and run **Validate App**. Resolve every App Store Connect validation error before upload.
