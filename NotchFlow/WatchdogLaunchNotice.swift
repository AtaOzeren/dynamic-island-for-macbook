...
struct WatchdogLaunchNotice {
    ...
    private var message: String {
        ...
        guard didRelaunch else {
            return String(
                format: String(
                    localized: "Last time, NotchFlow quit itself because CPU stayed high after three restarts. Report: %@",
        ...
        return String(
            format: String(
                localized: "NotchFlow restarted itself after sustained high CPU use. Report: %@",
